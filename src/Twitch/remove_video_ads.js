...
        `;
    ...
    this.onmessage = function (e) {
      if (e.data.key == "ShowAdBlockBanner") {
        ...
        adBlockDiv.style.display = "block"; //setting data-start-time as starting time of ad blocking
        ...
        adBlockDiv.style.display = "none"; // calculate duration of last ads
        ...
        if (startTime) {
          ...
          TwitchAdblockSettings.AdTime += duration; // post message to content.js to save adtime in local storage
          postMessage(
            {
    ...
    function getAdBlockDiv() {
      console.log("twitch getAdBlockDiv"); //To display a notification to the user, that an ad is being blocked.
