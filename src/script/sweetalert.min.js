!(function (t, e) {
    ...
    kt = function (t) {
      ...
      pt()
        ...
        : (((n = document.createElement("div")).className = J.container),
          ...
          (c = o),
          "rtl" === window.getComputedStyle(c).direction && vt(C(), J.rtl),
          (s = A()),
          (u = bt(s, J.input)),
          (l = bt(s, J.file)),
          (d = s.querySelector(".".concat(J.range, " input"))),
          (p = s.querySelector(".".concat(J.range, " output"))),
          (f = bt(s, J.select)),
          (m = s.querySelector(".".concat(J.checkbox, " input"))),
          (h = bt(s, J.textarea)),
          (u.oninput = ft),
          (l.onchange = ft),
          (f.onchange = ft),
  ...
  function Mt(t, e) {
    var n,
      ...
      r,
      a,
      c = A().querySelector("#".concat(J.content));
    e.html
      ? (mt(e.html, c), rt(c, "block"))
      : e.text
      ...
      s.progressSteps.forEach(function (t, e) {
        var n,
          ...
          c =
            ...
            o);
        u.appendChild(c),
          e === l && vt(c, J["active-progress-step"]),
  ...
  function Ht(t, e) {
    ...
    z(l, e, "header"),
      ...
      (a = e),
      (c = P()),
      st(c, a.title || a.titleText),
      a.title && mt(a.title, c),
      a.titleText && (c.innerText = a.titleText),
      z(c, a, "title"),
      (s = e),
      (u = R()),
      _(u, s.closeButtonHtml),
      z(u, s, "closeButton"),
      st(u, s.showCloseButton),
  ...
  var fe = function () {
    ...
    he = function (t) {
      ...
      return (
        t === e ||
        !(ut(e) || "INPUT" === t.tagName || (ut(A()) && A().contains(t)))
      );
    },
      ...
      (e = Ot.innerParams.get(this)) &&
        ...
        (function (t, e, n) {
          var o = C(),
            ...
            s = n.didClose;
          if ((be(e, c, r), i)) {
            we(t, e, o, s !== null && s !== void 0 ? s : a);
          } else {
            ve(t, o, G(), s !== null && s !== void 0 ? s : a);
          }
        })(this, i, e),
        n(t)));
  }
  ...
  function Ee(t) {
    var e,
      n = x();
    t.target === n &&
      ((e = C()), n.removeEventListener(Pt, Ee), (e.style.overflowY = "auto"));
  }
  function Oe(t, e) {
  ...
  function Me(t, e, n) {
    Ot.innerParams.get(t).toast ? an(t, e, n) : (sn(e), un(e), ln(t, e, n));
  }
  var Ve = function (t, e) {
      ...
      e.container.onmousedown = function () {
        e.popup.onmouseup = function (t) {
          (e.popup.onmouseup = void 0),
            (t.target !== e.popup && !e.popup.contains(t.target)) || (cn = !0);
        };
      };
    },
    ln = function (n, o, i) {
  ...
  var dn = function (t, e, n) {
    ...
    pn = function (t, e) {
      if (!e.toast)
        return Q(e.allowEnterKey) ? void (fn(t, e) || Ie(0, -1, 1)) : mn();
    },
    fn = function (t, e) {
  ...
  var hn,
    ...
    vn = Object.freeze({
      ...
      _main: function (t) {
        ...
        var e = (function (t) {
          var e = s({}, ie.showClass, t.showClass),
            n = s({}, ie.hideClass, t.hideClass),
            o = s({}, ie, t);
